...
export class DashboardComponent implements OnInit {
  ...
  constructor(private sidenav: SidenavService, private route: ActivatedRoute, private _vendorDetails: AdminCategoryService, public _configList: configList, public _login: LoginService) {
